...
public class EGA_DemoLasers : MonoBehaviour
{
    ...
    //    //RotateToMouseDirection(gameObject, pos_t.transform.position);
    //    #region old code
    //    ////Current fire point
    //    //if (Cam != null)
    //    //{
    ...
    //    //    RaycastHit2D hit = Physics2D.Raycast(RayMouse.origin, RayMouse.direction, MaxLength);
