...
public class EGA_Laser : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Laser != null && UpdateSaver == false)
        {
            ...
            //Laser.SetPosition(1, pos_t.transform.position);
            //HitEffect.transform.position = pos_t.transform.position;//hit.point + hit.normal * HitOffset;
            ...
            //}
            ////Texture tiling
            //Length[0] = MainTextureLength * (Vector3.Distance(transform.position, pos_t.transform.position));
            //Length[2] = NoiseTextureLength * (Vector3.Distance(transform.position, pos_t.transform.position));
